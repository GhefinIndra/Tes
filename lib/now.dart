                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                decoration: InputDecoration(labelText: 'Tech Name'),
                              ...
                              TextFormField(
                                decoration: InputDecoration(labelText: 'Lang'),
                              ...
                              ElevatedButton(
                                child: Text('Save'),
                                onPressed: () {
                                  if (col_selected == 'blue') col_selected = Colors.blue;
                                  else if (col_selected == 'green') col_selected = Colors.green;
                                  else if (col_selected == 'yellow') col_selected = Colors.yellow;
                                  setState(() {
                                    data.add({
